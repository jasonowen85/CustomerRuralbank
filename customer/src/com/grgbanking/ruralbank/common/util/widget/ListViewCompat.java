package com.grgbanking.ruralbank.common.util.widget;
...
import com.grgbanking.ruralbank.common.util.Utils;
...
public class ListViewCompat extends ListView implements OnScrollListener {
    ...
    //下拉的固定高度；
    private static final int LIMITPULLHEIGHT = 110;
    ...
    private void whenMove(MotionEvent ev) {
        ...
        if(topPadding >= LIMITPULLHEIGHT)  {
            topPadding = LIMITPULLHEIGHT;
        }
        switch (state) {
            case NONE:
                if (space > 0) {
