package com.grgbanking.ruralbank;
...
import com.grgbanking.ruralbank.common.util.crash.AppCrashHandler;
import com.grgbanking.ruralbank.common.util.sys.SystemUtil;
...
import com.grgbanking.ruralbank.contact.ContactHelper;
...
public class NimApplication extends Application {
    ...
    public static String lastDeviceTypeId;
    public static String lastSupplierId;
    public static String lastEndtime;
    public static String lastStarttime;
    //指定匹配apk包名 接收 本客户端发送出去的消息；其他客户端接收不到消息；
    ...
    public void onCreate() {
        ...
        CrashReport.initCrashReport(getApplicationContext(), "900055241", false);
    ...
    private SDKOptions getOptions() {
        ...
        // 通知铃声的uri字符串
        config.notificationSound = "android.resource://com.grgbanking.ruralbank/raw/msg";
