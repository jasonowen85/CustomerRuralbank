package com.grgbanking.ruralbank.config.preference;
...
public class UserPreferences {
    ...
    private final static String KEY_FIRST_COMEIN = "is_first_comein";
    // 测试过滤通知
    ...
    public static boolean getIsFirstComeIn() {
        return getBoolean(KEY_FIRST_COMEIN, false);
    }

    public static void setIsFirstComeIn(boolean on) {
        saveBoolean(KEY_FIRST_COMEIN, on);
    }
